...
const mergeProps = (stateProps, dispatchProps, ownProps) => {
  ...
  return {
    ...
    init() {
      ...
      WebMidiWrapper.webMidi.addListener(
        MIDIDeviceStateChange.Connected,
        event => {
      ...
      WebMidiWrapper.webMidi.addListener(
        MIDIDeviceStateChange.Disconnected,
        event => {
